...
// sent. `announced` records whether a matching ADD was seen; it is false for a
// rotator known only through POINT, which should not happen on a healthy
// connection but is not worth discarding a heading over.
